  ...
  return (
    <Table>
      ...
      <TableBody>
        {rows.length === 0 ? (
          <TableRow>
            <TableCell colSpan={showLegalEntity ? 10 : 9} className="px-3 py-6 text-center text-sm text-slate-500">
              {emptyText}
            </TableCell>
          </TableRow>
        ) : (
            ...
            return (
              ...
              >
                ...
                <TableCell className="px-3 py-2">
                  <StatusBadge status={row.status} mismatch={row.mismatch} />
                </TableCell>
                ...
                <TableCell className={`whitespace-nowrap px-3 py-2 text-right tabular-nums ${row.plan - row.fact !== 0 ? "font-medium text-red-700" : ""}`}>
