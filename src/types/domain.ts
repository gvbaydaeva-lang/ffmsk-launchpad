...
export type InboundWarehouseRequestStatus = "new" | "receiving" | "received" | "placed" | "cancelled";
...
export type OutboundShipment = {
  ...
  expiryDate: string;
  packedUnits: number;
  /** Упаковано (скан упаковщика); отдельно от подбора, при отсутствии поля в UI = 0. */
